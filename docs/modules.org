...
mapping to add full-height horizontal columns. CMacs loads all four by
...
offscreen columns, and the viewport clips content to its own monitor.
...
Super+t selects tile, and Super+[ / Super+] scroll the column strip.
