...
static const gchar *default_yaml_config =
	...
	"\n"
	"  # Super+f is the window, not the layout: fullscreen is what you\n"
	"  # reach for mid-task, and changing the tag's layout by accident\n"
	"  # while looking for it is the more expensive mistake.\n"
	"  \"Super+f\": { action: toggle_fullscreen }\n"
	"\n"
	"  # Layout selection\n"
	"  \"Super+t\": { action: set_layout, arg: \"tile\" }\n"
	"  \"Super+Shift+f\": { action: set_layout, arg: \"float\" }\n"
